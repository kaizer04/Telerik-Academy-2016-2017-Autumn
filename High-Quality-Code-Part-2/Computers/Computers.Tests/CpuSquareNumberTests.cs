namespace Computers.Tests
{
    ...
    public class CpuSquareNumberTests
    {
        ...
        public void SquareNumberShouldOutputCorrectValues()
        {
            ...
            motherboardMock.Verify(x => x.DrawOnVideoCard(It.Is<string>(param => param.Contains("15129"))));
        }
        ...
        public void SquareNumberShouldDrawErrorMessageWhenValueIsLessThanZero()
        {
            ...
            motherboardMock.Verify(x => x.DrawOnVideoCard(It.Is<string>(param => param == Cpu.NumberTooLowMessage)));
        }
        ...
        public void SquareNumberInCpu32ShouldDrawErrorMessageWhenValueIsGreaterThanMaxValue()
        {
            ...
            motherboardMock.Verify(x => x.DrawOnVideoCard(It.Is<string>(param => param == Cpu.NumberTooHighMessage)));
        }
