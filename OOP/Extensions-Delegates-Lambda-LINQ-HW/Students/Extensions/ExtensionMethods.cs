namespace Students
{
    ...
    public static class ExtensionMethods
    {
        ...
        {
            var studentsToReturn = from student in list
        ...
        public static Student[] OrderByGroupNumber(this IEnumerable<Student> listOfStudents)
        {
            return listOfStudents.OrderBy(x => x.GroupNumber).ToArray();
        }
    }
}